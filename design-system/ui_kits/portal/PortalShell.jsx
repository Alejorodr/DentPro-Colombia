...
const NAV_BY_ROLE = {
  ADMINISTRADOR: {
    ...
    nav: [
      ...
      { key: "specialties", label: "Specialties", icon: PI.Stethoscope },
      { key: "services", label: "Services & Pricing", icon: PI.CreditCard },
      { key: "scheduling", label: "Scheduling Ops", icon: PI.CalendarCheck },
      { key: "content", label: "Content CMS", icon: PI.SquaresFour },
      { key: "templates", label: "Clinical Templates", icon: PI.FileText },
  ...
  RECEPCIONISTA: {
    ...
    nav: [
      ...
      { key: "billing", label: "Billing", icon: PI.CreditCard },
    ],
    settings: [{ key: "settings", label: "Settings", icon: PI.Gear }],
  },
};
