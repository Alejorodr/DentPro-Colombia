    ...
    <div className="space-y-6 rounded-2xl bg-white p-8 shadow-lg shadow-brand-teal/10 ring-1 ring-slate-200 transition-colors duration-300 dark:bg-surface-base dark:ring-surface-muted">
      <div className="space-y-2 text-left">
        ...
        <div className="space-y-1">
          <h1 className="text-2xl font-semibold text-slate-900 dark:text-white">Inicia sesión en DentPro</h1>
          <p className="text-sm text-slate-600 dark:text-slate-300">
            Usa las credenciales que te compartió el equipo administrador para acceder a tu tablero.
          </p>
        </div>
      </div>
