          ...
          <div className="relative z-10">
            <div className="card border-white/40 bg-white/80 p-6 shadow-xl shadow-brand-teal/20 backdrop-blur transition-colors duration-500 hover:!translate-y-0 hover:!shadow-xl dark:!border-accent-cyan/10 dark:!bg-surface-elevated/70 dark:shadow-surface-dark lg:p-8">
              ...
              <div className="card mt-6 grid gap-4 rounded-2xl bg-white/90 p-6 text-sm !shadow-lg transition-colors duration-500 hover:!translate-y-0 hover:!shadow-lg dark:!bg-surface-muted/90 dark:text-slate-100">
                ...
                <p className="text-slate-600 dark:text-slate-200">ÔÇ£{testimonial.quote}ÔÇØ</p>
            ...
            <div className="card mx-auto mt-6 w-full max-w-xs space-y-2 border-white/60 p-5 text-center text-sm text-slate-700 !shadow-glow backdrop-blur transition-colors duration-500 hover:!translate-y-0 hover:!shadow-glow dark:!border-accent-cyan/15 dark:!bg-surface-elevated/90 dark:text-slate-100 dark:shadow-glow-dark sm:absolute sm:-bottom-12 sm:right-6 sm:mx-0 sm:mt-0 sm:text-left sm:shadow-lg sm:p-6">
              <p className="text-xs uppercase tracking-wide text-slate-500 dark:text-accent-cyan/80">Indicadores cl├¡nicos</p>
