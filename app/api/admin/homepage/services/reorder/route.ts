...
export async function PATCH(request: Request) {
  ...
  try {
    ...
    await logAuditEvent({
      ...
      action: "homepage.services.reordered",
    ...
    logApiError(
      {
        event: "admin.homepage_services.reorder_failed",
        route: "/api/admin/homepage/services/reorder",
        userId: auth.sessionUser.id,
      },
      error,
    );
    return errorResponse("No se pudo actualizar el orden de servicios.", 500);
  }
}
