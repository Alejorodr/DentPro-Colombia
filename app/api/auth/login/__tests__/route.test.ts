...
describe("POST /api/auth/login", () => {
  ...
  it("falls back to the generated database when the configured SQLite file is missing", async () => {
    process.env = {
      ...ORIGINAL_ENV,
      AUTH_JWT_SECRET: "test-secret-key",
      NODE_ENV: "test",
      DATABASE_URL: "file:./nonexistent-login.db",
    };
    ...
    const missingAbsolutePath = pathModule.join(process.cwd(), "nonexistent-login.db");
