...
- [ ] **Step 1: Add next/font/google imports and font instances to app/layout.tsx**
...
- [ ] **Step 2: Apply the font variable classNames to the `<html>` element**
...
- [ ] **Step 3: Update app/globals.css to consume the font variables**
...
- [ ] **Step 4: Verify the build succeeds and fonts load correctly**
...
- [ ] **Step 5: Manually verify fonts render correctly**
...
- [ ] **Step 4: Manually verify — with and without a logo set**
...
- [ ] **Step 1: Add the two new devDependencies**
...
- [ ] **Step 2: Add the `analyze` script to package.json**
...
- [ ] **Step 3: Wire the bundle analyzer into next.config.ts**
...
- [ ] **Step 4: Verify a normal build still works (analyzer inert by default)**
...
- [ ] **Step 2: Note the largest contributors**
...
- [ ] **Step 2: Start a production server and re-run Lighthouse**
